...
class MagazinesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create magazine" do
    assert_difference('Magazine.count') do
      post magazines_url, params: { magazine: { description: @magazine.description, name: @magazine.name } }
    end
  ...
  test "should update magazine" do
    patch magazine_url(@magazine), params: { magazine: { description: @magazine.description, name: @magazine.name } }
